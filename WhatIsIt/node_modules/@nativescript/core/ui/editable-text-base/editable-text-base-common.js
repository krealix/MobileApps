...
const keyboardTypeConverter = makeParser(makeValidator('datetime', 'phone', 'number', 'url', 'email', 'integer'), true);
...
const returnKeyTypeConverter = makeParser(makeValidator('done', 'next', 'go', 'search', 'send'), true);
...
const autocapitalizationTypeConverter = makeParser(makeValidator('none', 'words', 'sentences', 'allcharacters'), true);
